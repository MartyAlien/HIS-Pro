...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'InnoDB free: 10240 kB; (`cid`) REFER `his/checkitem`(`id`); (`pid`) REFER `his/p' ROW_FORMAT = Compact;
...
) ENGINE = InnoDB AUTO_INCREMENT = 10 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'InnoDB free: 10240 kB; (`deptid`) REFER `his/dept`(`id`)' ROW_FORMAT = Compact;
...
) ENGINE = InnoDB AUTO_INCREMENT = 53 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'InnoDB free: 10240 kB; (`inspectid`) REFER `his/inspectitem`(`id`); (`pid`) REFE' ROW_FORMAT = Compact;
...
INSERT INTO `inspectitemrecord` VALUES (33, 180666388, 3, 1, 1);
...
) ENGINE = InnoDB AUTO_INCREMENT = 32 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'InnoDB free: 10240 kB; (`pid`) REFER `his/patient`(`pid`); (`operator`) REFER `h' ROW_FORMAT = Compact;
...
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'InnoDB free: 10240 kB; (`deptid`) REFER `his/dept`(`id`); (`doctorid`) REFER `hi' ROW_FORMAT = Compact;
...
INSERT INTO `patient` VALUES (1007798, '特朗普', '男', 76, NULL, '122515194401011852', '美国白宫', 2, 1, 2, '2021-01-19', 21, '1', 1, 1, '2021-01-18 13:39:57');
...
INSERT INTO `patient` VALUES (196102016, '欧豪', '男', 20, NULL, '510152199910101852', '四川省', 2, 2, 3, '2021-01-08', 20, '0', 1, 1, '2021-01-08 16:01:35');
